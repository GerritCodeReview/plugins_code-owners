...
export class CodeOwnersBanner extends LitElement {
  ...
  protected override willUpdate(changedProperties: PropertyValues): void {
    ...
    if (changedProperties.has('pluginStatus')) {
      this.hidden =
        !this.pluginStatus || isPluginErrorState(this.pluginStatus.state);
    }
  }
...
export class CodeOwnersPluginStatusNotifier extends base {
  ...
  static get observers() {
    return ['_pluginStatusOrBannerChanged(model.pluginStatus, banner)'];
  }
  ...
  protected override willUpdate(changedProperties: PropertyValues) {
    ...
    this.banner.pluginStatus = this.model!.pluginStatus;
  }
