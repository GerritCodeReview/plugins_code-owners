...
import {HttpMethod, RestPluginApi} from 'google3/third_party/javascript/polygerrit/api/rest';
import {AccountDetailInfo, AccountInfo, BranchName, ChangeInfo, NumericChangeId, RepoName,} from 'google3/third_party/javascript/polygerrit/api/rest-api';
