...
export class CodeOwnersModel extends EventTarget {
  ...
  setSuggestionsFiles(
    ...
    this.fireSuggestionsChanged(suggestionsType, 'files');
  }
  ...
  setSuggestionsState(
    ...
    this.fireSuggestionsChanged(suggestionsType, 'state');
  }
  ...
  setSuggestionsLoadProgress(
    ...
    this.fireSuggestionsChanged(suggestionsType, 'loadProgress');
  }
  ...
  private fireSuggestionsChanged(
    suggestionsType: SuggestionsType,
    propertyName: string
  ) {
