...
### <a id="code-owner-scoring-factor-info"> CodeOwnerScoringFactorInfo
The `CodeOwnerScoringFactorInfo` entity contains information about a code owner [scoring factor](#scoringFactors).
