...
:       The path expression syntax that is used in
        ...
        **NOTE:** Be careful with changing this parameter as it affects how path
        ...
        expressions may now match different files, or even worse the existing
        path expressions may no longer be valid and fail to parse, in which case
        they would not match anything any more.
