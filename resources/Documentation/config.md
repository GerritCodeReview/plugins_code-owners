...
:       Whether code owner approvals should be sticky on the files they approve,
        ...
        invalidated if the approval is revoked, changed or re-applied, but not
        by the upload of a new patch set regardless of whether the new patch
        sets changes these files.\
        \
