...
sticky approvals in the plugin configuration](config.md#pluginCodeOwnersEnableStickyApprovals).
...
* groups are supported (permissions can be assigned to groups, but code
  ...
  groups](backend-find-owners-cookbook.md#defineAGroupAsCodeOwner))
