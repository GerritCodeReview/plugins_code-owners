      ...
      setTimeout(
        () =>
          resolve({
            ...
            file_owner_statuses: {
              /* eslint-disable */
              "package.json": OwnerStatus.APPROVED,
              ".eslintrc.json": OwnerStatus.INSUFFICIENT_REVIEWERS,
              BUILD: OwnerStatus.PENDING,
              "ui/code-owners-service.js": OwnerStatus.INSUFFICIENT_REVIEWERS,
              "ui/owner-status-column.js": OwnerStatus.APPROVED,
              "ui/plugin.js": OwnerStatus.PENDING,
    ...
    return this.statusPromise.then(({ file_owner_statuses }) => {
      return Object.keys(ownersFilesMap).map((ownersKey) => {
        ...
        return {
          ...
          status: file_owner_statuses[ownersFilesMap[ownersKey][0]],
