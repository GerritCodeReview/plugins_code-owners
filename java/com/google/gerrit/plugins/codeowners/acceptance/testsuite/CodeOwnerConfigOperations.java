...
public interface CodeOwnerConfigOperations {
  ...
  interface PerCodeOwnerConfigOperations {
     ...
     * </pre>
     *
     * <p><strong>Note:</strong> The update will fail with an exception if the code owner config to
     * update doesn't exist. If you want to check for the existence of a code owner config, use
     * {@link #exists()}.
     *
