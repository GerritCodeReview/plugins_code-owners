...
public final class CodeOwnersExperimentFeaturesConstants {
  /**
   * Whether the new diff cache should be used to get changed files, instead of computing the
   * changed files on our own.
   *
   * @see ChangedFiles#getOrCompute(com.google.gerrit.entities.Project.NameKey,
   *     org.eclipse.jgit.lib.ObjectId)
   */
  public static final String USE_NEW_DIFF_CACHE =
      "GerritBackendRequestFeature__code_owners_use_new_diff_cache";
