...
import com.google.gerrit.plugins.codeowners.config.AbstractRequiredApprovalConfig;
 ...
 */
@Singleton
public class CodeOwnersPluginConfiguration implements CodeOwnerMergeCommitStrategy {
   ...
   */
  public ImmutableList<RequiredApproval> getConfiguredRequiredApproval(
