    ...
    try (Timer0.Context ctx = codeOwnerMetrics.resolveCodeOwnerConfigImports.start()) {
      ...
      while (!codeOwnerConfigsToImport.isEmpty()) {
        ...
        CodeOwnerConfigReference codeOwnerConfigReference =
            codeOwnerConfigImport.codeOwnerConfigReference();
                          ...
                          codeOwnerCfgImport ->
                              CodeOwnerConfigImport.create(
                                  ...
                                  CodeOwnerConfigReference.copyWithNewImportMode(
                                      codeOwnerCfgImport.codeOwnerConfigReference(),
                                      CodeOwnerConfigImportMode.GLOBAL_CODE_OWNER_SETS_ONLY),
    ...
    public String format() {
      if (codeOwnerSet().isPresent()) {
        return getPrefix()
            + String.format(
                ...
                codeOwnerConfigReference().format(),
      ...
      return getPrefix()
          + String.format(
              ...
              codeOwnerConfigReference().format(), codeOwnerConfigReference().importMode());
    }
