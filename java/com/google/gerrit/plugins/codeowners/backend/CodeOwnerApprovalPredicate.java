...
public class CodeOwnerApprovalPredicate extends Predicate<ChangeData>
  ...
  public boolean match(ChangeData changeData) {
    try {
      ...
      try (Timer0.Context ctx = codeOwnerMetrics.runCodeOwnerSubmitRule.start()) {
        ...
        requireNonNull(changeData.notes(), "changeNotes");
        return codeOwnerApprovalCheck.isSubmittable(changeData.notes());
      }
