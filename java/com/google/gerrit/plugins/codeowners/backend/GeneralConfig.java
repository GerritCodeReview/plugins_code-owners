...
public class GeneralConfig {
      ...
      validationMessages.add(
          new CommitValidationMessage(
              String.format(
                  ...
                  projectLevelConfig
                      .getConfig()
                      .getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_MERGE_COMMIT_STRATEGY),
                  fileName,
                  StatusConfig.SECTION_CODE_OWNERS,
                  KEY_MERGE_COMMIT_STRATEGY),
      ...
      validationMessages.add(
          new CommitValidationMessage(
              String.format(
                  ...
                  projectLevelConfig
                      .getConfig()
                      .getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FALLBACK_CODE_OWNERS),
                  fileName,
                  StatusConfig.SECTION_CODE_OWNERS,
                  KEY_FALLBACK_CODE_OWNERS),
              ValidationMessage.Type.ERROR));
  ...
  Optional<String> getFileExtension(Config pluginConfig) {
    ...
    String fileExtension =
        pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FILE_EXTENSION);
  ...
  boolean getReadOnly(Config pluginConfig) {
    ...
    if (pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_READ_ONLY) != null) {
      return pluginConfig.getBoolean(StatusConfig.SECTION_CODE_OWNERS, null, KEY_READ_ONLY, false);
    }
  ...
  FallbackCodeOwners getFallbackCodeOwners(Project.NameKey project, Config pluginConfig) {
    ...
    String fallbackCodeOwnersString =
        pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FALLBACK_CODE_OWNERS);
  ...
  CodeOwnerConfigValidationPolicy getCodeOwnerConfigValidationPolicyForCommitReceived(
    ...
    String codeOwnerConfigValidationPolicyString =
        pluginConfig.getString(
            StatusConfig.SECTION_CODE_OWNERS, null, KEY_ENABLE_VALIDATION_ON_COMMIT_RECEIVED);
  ...
  MergeCommitStrategy getMergeCommitStrategy(Project.NameKey project, Config pluginConfig) {
    ...
    String mergeCommitStrategyString =
        pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_MERGE_COMMIT_STRATEGY);
  ...
  ImmutableSet<CodeOwnerReference> getGlobalCodeOwners(Config pluginConfig) {
    ...
    if (pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_GLOBAL_CODE_OWNER)
        != null) {
      return Arrays.stream(
              pluginConfig.getStringList(
                  StatusConfig.SECTION_CODE_OWNERS, null, KEY_GLOBAL_CODE_OWNER))
  ...
  Optional<String> getOverrideInfoUrl(Config pluginConfig) {
    ...
    String fileExtension =
        pluginConfig.getString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_OVERRIDE_INFO_URL);
    if (fileExtension != null) {
      return Optional.of(fileExtension);
    }
