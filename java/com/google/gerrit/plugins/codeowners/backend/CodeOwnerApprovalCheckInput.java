...
public abstract class CodeOwnerApprovalCheckInput {
  ...
  /**
   * Gets the IDs of the accounts that all reviewers that can possibly code owner approve the change
  ...
  private static CodeOwnerApprovalCheckInput create(
    ...
    return new AutoValue_CodeOwnerApprovalCheckInput(
        reviewers,
        approvers,
        Optional.ofNullable(implicitApprover),
        overrides,
        globalCodeOwners,
        fallbackCodeOwners,
        checkAllOwners);
  ...
  public static class Loader {
    ...
    private final Account.Id patchSetUploader;
    ...
    Loader(
        ...
        @Assisted Account.Id patchSetUploader) {
      this.approvalsUtil = approvalsUtil;
      this.codeOwnerMetrics = codeOwnerMetrics;
      this.codeOwnersConfig = codeOwnersConfig;
      this.codeOwnerResolver = codeOwnerResolver;
      this.changeNotes = changeNotes;
      this.patchSetUploader = patchSetUploader;
    }
    ...
    CodeOwnerApprovalCheckInput load() {
      ...
      return CodeOwnerApprovalCheckInput.create(
          getReviewers(),
          getApprovers(),
          getImplicitApprover().orElse(null),
          getOverrides(),
          getGlobalCodeOwners(),
    ...
    /**
     * Gets the IDs of the accounts that all reviewers that can possibly code owner approve the
     * change (if they are code owners).
     *
