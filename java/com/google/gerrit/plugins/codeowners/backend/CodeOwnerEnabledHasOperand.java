...
public class CodeOwnerEnabledHasOperand implements ChangeHasOperandFactory {
  ...
  @Inject
  public CodeOwnerEnabledHasOperand(CodeOwnersPluginConfiguration codeOwnersPluginConfiguration) {
    this.codeOwnersPluginConfiguration = codeOwnersPluginConfiguration;
  }

  @Override
  public Predicate<ChangeData> create(ChangeQueryBuilder builder) throws QueryParseException {
    return new CodeOwnerEnabledPredicate(codeOwnersPluginConfiguration);
  }
}
