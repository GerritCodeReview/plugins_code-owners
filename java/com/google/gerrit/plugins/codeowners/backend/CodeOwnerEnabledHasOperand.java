...
public class CodeOwnerEnabledHasOperand implements ChangeHasOperandFactory {
  ...
  private final Provider<CodeOwnerEnabledPredicate> codeOwnerEnabledPredicateProvider;

  @Inject
  public CodeOwnerEnabledHasOperand(
      Provider<CodeOwnerEnabledPredicate> codeOwnerEnabledPredicateProvider) {
    this.codeOwnerEnabledPredicateProvider = codeOwnerEnabledPredicateProvider;
  }

  @Override
  public Predicate<ChangeData> create(ChangeQueryBuilder builder) throws QueryParseException {
    return codeOwnerEnabledPredicateProvider.get();
  }
}
