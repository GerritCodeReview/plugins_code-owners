 ...
 *
 * <p>Immutable means that the entry value cannot be updated via the {@link #setValue(Object)}. Any
 * attempt to do so results in a {@link IllegalStateException}.
 *
 * <p>By using this class map entries in a stream can be mapped to map entries with other key or
 * value types. E.g.:
 *
 * <pre>
 ...
 * such a mapping would require collecting the entries of a map and then creating a new stream,
