...
public class GetCodeOwnersForPathInBranch
  ...
  private static ImmutableList<CodeOwner> sortCodeOwners(
    ...
    ImmutableList<CodeOwner> randomlyOrderedCodeOwners = randomOrder(codeOwners);
   ...
   */
  private static ImmutableList<CodeOwner> randomOrder(ImmutableSet<CodeOwner> codeOwners) {
