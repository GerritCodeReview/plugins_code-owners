...
public class RequiredApprovalSubject extends Subject {
  /**
   * Starts fluent chain to do assertions on a {@link RequiredApproval}.
   *
  ...
  /**
   * Starts fluent chain to do assertions on an {@link Optional} {@link RequiredApproval}.
   *
  ...
  /**
   * Starts fluent chain to do assertions on a list of {@link RequiredApproval}s.
   *
  ...
  /**
   * Creates subject factory for mapping {@link RequiredApproval}s to {@link
