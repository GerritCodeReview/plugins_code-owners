...
public class FileCodeOwnerStatusInfoSubject extends Subject {
  ...
  public OptionalSubject<PathCodeOwnerStatusInfoSubject, ?> hasNewPathCodeOwnerStatusThat() {
    return check("newPathCodeOwnerStatus()")
        .about(optionals())
        .thatCustom(
            Optional.ofNullable(fileCodeOwnerStatusInfo().newPathCodeOwnerStatus),
            pathCodeOwnerStatusInfos());
  }

  /** Returns an {@link OptionalSubject} for the code owners status of the old path. */
  public OptionalSubject<PathCodeOwnerStatusInfoSubject, ?> hasOldPathCodeOwnerStatusThat() {
    return check("oldPathCodeOwnerStatus()")
        .about(optionals())
        .thatCustom(
            Optional.ofNullable(fileCodeOwnerStatusInfo().oldPathCodeOwnerStatus),
            pathCodeOwnerStatusInfos());
  }
