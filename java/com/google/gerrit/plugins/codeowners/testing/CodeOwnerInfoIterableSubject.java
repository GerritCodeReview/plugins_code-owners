...
public class CodeOwnerInfoIterableSubject extends IterableSubject {
   ...
   *
   * @param codeOwnerInfos the code owners on which assertions should be done
   * @return the created {@link CodeOwnerInfoIterableSubject}
   */
  public static CodeOwnerInfoIterableSubject assertThat(Iterable<CodeOwnerInfo> codeOwnerInfos) {
    return assertAbout(CodeOwnerInfoIterableSubject::new).that(codeOwnerInfos);
  }

  private final Iterable<CodeOwnerInfo> codeOwnerInfos;

  private CodeOwnerInfoIterableSubject(
      FailureMetadata metadata, Iterable<CodeOwnerInfo> codeOwnerInfos) {
  ...
  private Iterable<CodeOwnerInfo> codeOwnerInfos() {
    isNotNull();
