...
public class SubmitRecordSubject extends Subject {
   ...
   * com.google.gerrit.common.data.SubmitRecord.Status}es.
   */
  public static class StatusSubject extends Subject {
    ...
    /**
     * Checks whether the status is {@link com.google.gerrit.common.data.SubmitRecord.Status#OK}.
     */
    public void isOk() {
     ...
     * com.google.gerrit.common.data.SubmitRecord.Status#NOT_READY}.
     */
    ...
    /**
     * Checks whether the status is {@link
     * com.google.gerrit.common.data.SubmitRecord.Status#RULE_ERROR}.
     */
