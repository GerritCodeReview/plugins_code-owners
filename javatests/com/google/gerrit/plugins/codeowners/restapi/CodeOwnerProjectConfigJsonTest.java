...
public class CodeOwnerProjectConfigJsonTest extends AbstractCodeOwnersTest {
  ...
  public void cannotFormatNullRequiredApproval() throws Exception {
    NullPointerException npe =
        assertThrows(
            ...
            () -> CodeOwnerProjectConfigJson.formatRequiredApproval(null));
  ...
  public void formatBackendIds() throws Exception {
    ...
    // The entries for the master and refs/meta/config branches are omitted since its backend
    // doesn't differ from the project-level backend.
