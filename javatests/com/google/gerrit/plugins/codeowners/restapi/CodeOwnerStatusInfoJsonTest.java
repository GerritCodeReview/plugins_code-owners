...
public class CodeOwnerStatusInfoJsonTest {
  ...
  public void formatFileCodeOwnerStatusForNewFile() throws Exception {
    ...
    assertThat(fileCodeOwnerStatusInfo)
        ...
        .hasCodeOwnerStatusThat()
        .isEqualTo(CodeOwnerStatus.APPROVED);
    assertThat(fileCodeOwnerStatusInfo).hasOldPathCodeOwnerStatusThat().isEmpty();
  }
  ...
  public void formatFileCodeOwnerStatusForDeletedFile() throws Exception {
    ...
    assertThat(fileCodeOwnerStatusInfo).hasNewPathCodeOwnerStatusThat().isEmpty();
    assertThat(fileCodeOwnerStatusInfo)
        .hasOldPathCodeOwnerStatusThat()
        .value()
        .hasPathThat()
        .isEqualTo("foo/bar.baz");
    assertThat(fileCodeOwnerStatusInfo)
  ...
  public void formatCodeOwnerStatusInfo() throws Exception {
    ...
    fileCodeOwnerStatusInfoSubject
        ...
        .hasCodeOwnerStatusThat()
        .isEqualTo(CodeOwnerStatus.APPROVED);
    fileCodeOwnerStatusInfoSubject.hasOldPathCodeOwnerStatusThat().isEmpty();
  }
  ...
  public void fileCodeOwnerStatusInfosInCodeOwnerStatusInfoAreSortedByPath() throws Exception {
    ...
    listSubject
        ...
        .value()
        .hasPathThat()
        .isEqualTo("foo/a/bar.baz");
    listSubject
        .element(1)
        .hasOldPathCodeOwnerStatusThat()
        .value()
        .hasPathThat()
        .isEqualTo("foo/b/bar.baz");
    listSubject
        .element(2)
        .hasNewPathCodeOwnerStatusThat()
        .value()
        .hasPathThat()
        .isEqualTo("foo/c/new.baz");
  }
}
