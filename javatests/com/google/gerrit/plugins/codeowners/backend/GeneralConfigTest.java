...
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_ENABLE_IMPLICIT_APPROVALS;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_ENABLE_VALIDATION_ON_COMMIT_RECEIVED;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_FALLBACK_CODE_OWNERS;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_FILE_EXTENSION;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_GLOBAL_CODE_OWNER;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_MERGE_COMMIT_STRATEGY;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_OVERRIDE_INFO_URL;
import static com.google.gerrit.plugins.codeowners.backend.GeneralConfig.KEY_READ_ONLY;
...
/** Tests for {@link com.google.gerrit.plugins.codeowners.backend.GeneralConfig}. */
public class GeneralConfigTest extends AbstractCodeOwnersTest {
  ...
  public void fileExtensionInPluginConfigOverridesFileExtensionInGerritConfig() throws Exception {
    ...
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FILE_EXTENSION, "bar");
  ...
  public void readOnlyConfigurationInPluginConfigOverridesReadOnlyConfigurationInGerritConfig()
      throws Exception {
    Config cfg = new Config();
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_READ_ONLY, "false");
  ...
  public void
    ...
    Config cfg = new Config();
    cfg.setString(
        StatusConfig.SECTION_CODE_OWNERS, null, KEY_ENABLE_VALIDATION_ON_COMMIT_RECEIVED, "true");
  ...
  public void invalidMergeCommitStrategyInPluginConfigIsIgnored() throws Exception {
    Config cfg = new Config();
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_MERGE_COMMIT_STRATEGY, "INVALID");
    assertThat(generalConfig.getMergeCommitStrategy(project, cfg))
        .isEqualTo(MergeCommitStrategy.FILES_WITH_CONFLICT_RESOLUTION);
  }
  ...
  public void validateInvalidProjectLevelConfig_invalidMergeCommitStrategy() throws Exception {
    ProjectLevelConfig.Bare cfg = new ProjectLevelConfig.Bare("code-owners.config");
    cfg.getConfig()
        .setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_MERGE_COMMIT_STRATEGY, "INVALID");
  ...
  public void
      enableImplicitApprovalsConfigurationInPluginConfigOverridesEnableImplicitApprovalsConfigurationInGerritConfig()
          throws Exception {
    Config cfg = new Config();
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_ENABLE_IMPLICIT_APPROVALS, "false");
  ...
  public void globalCodeOnwersInPluginConfigOverrideGlobalCodeOwnersInGerritConfig()
    ...
    Config cfg = new Config();
    cfg.setString(
        StatusConfig.SECTION_CODE_OWNERS, null, KEY_GLOBAL_CODE_OWNER, "bot3@example.com");
  ...
  public void overrideInfoUrlInPluginConfigOverridesOverrideInfoUrlInGerritConfig()
    ...
    Config cfg = new Config();
    cfg.setString(
        StatusConfig.SECTION_CODE_OWNERS, null, KEY_OVERRIDE_INFO_URL, "http://bar.example.com");
  ...
  public void fallbackCodeOwnersInPluginConfigOverridesFallbackCodeOwnersInGerritConfig()
      throws Exception {
    Config cfg = new Config();
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FALLBACK_CODE_OWNERS, "NONE");
  ...
  public void globalFallbackOnwersUsedIfInvalidFallbackCodeOwnersConfigured() throws Exception {
    Config cfg = new Config();
    cfg.setString(StatusConfig.SECTION_CODE_OWNERS, null, KEY_FALLBACK_CODE_OWNERS, "INVALID");
    assertThat(generalConfig.getFallbackCodeOwners(project, cfg))
        .isEqualTo(FallbackCodeOwners.ALL_USERS);
  }
