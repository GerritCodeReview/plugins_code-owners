...
/** Tests for {@link CodeOwnersBackendId}. */
public class CodeOwnersBackendIdTest extends AbstractCodeOwnersTest {
  ...
  @Test
  public void codeOwnersBackendIdEnumMatchesRegisteredBackends() throws Exception {
    assertThat(CodeOwnersBackendId.values())
        .asList()
        .comparingElementsUsing(
            Correspondence.<CodeOwnersBackendId, String>from(
