  ...
  public void checkCodeOwner() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is a code owner of path '%s'", codeOwner.email(), path));
  }
  ...
  public void checkCodeOwner_secondaryEmail() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("resolved to account %s", codeOwner.id()),
            String.format("email %s is a code owner of path '%s'", secondaryEmail, ROOT_PATH));
  }
  ...
  public void checkNonCodeOwner() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is not a code owner of path '%s'", user.email(), ROOT_PATH));
  }
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                ...
                nonExistingEmail),
            String.format(
                "email %s is not a code owner of path '%s'", nonExistingEmail, ROOT_PATH));
  }
  ...
  public void checkAmbiguousExistingEmail() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("cannot resolve code owner email %s: email is ambiguous", ambiguousEmail),
            String.format("email %s is not a code owner of path '%s'", ambiguousEmail, ROOT_PATH));
  }
  ...
  public void checkOrphanedEmail() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is not a code owner of path '%s'", orphanedEmail, ROOT_PATH));
  }
  ...
  public void checkInactiveAccount() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                "email %s is not a code owner of path '%s'", inactiveUser.email(), ROOT_PATH));
  }
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                ...
                emailWithAllowedEmailDomain),
            String.format(
                "email %s is a code owner of path '%s'", emailWithAllowedEmailDomain, ROOT_PATH));
  }
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                ...
                emailWithNonAllowedEmailDomain),
            String.format(
                "email %s is not a code owner of path '%s'",
                emailWithNonAllowedEmailDomain, ROOT_PATH));
  }
  ...
  public void checkAllUsersWildcard() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        ...
        .contains(
            String.format(
                "email %s is not a code owner of path '%s'",
                CodeOwnerResolver.ALL_USERS_WILDCARD, ROOT_PATH));
  }
  ...
  public void checkAllUsersWildcard_ownedByAllUsers() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                "email %s is a code owner of path '%s'",
                CodeOwnerResolver.ALL_USERS_WILDCARD, ROOT_PATH));
  }
  ...
  public void checkDefaultCodeOwner() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is a code owner of path '%s'", defaultCodeOwner.email(), path));
  }
  ...
  public void checkGlobalCodeOwner() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is a code owner of path '%s'", globalCodeOwner.email(), path));
  }
  ...
  public void checkNonVisibleCodeOwnerForOtherUser() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format(
                "email %s is not a code owner of path '%s'", codeOwner.email(), ROOT_PATH));
  }
  ...
  public void checkNonVisibleCodeOwnerForOtherUser_secondaryEmail() throws Exception {
    ...
    assertThat(checkCodeOwnerInfo)
        .hasDebugLogsThatContainAllOf(
            ...
            String.format("email %s is not a code owner of path '%s'", secondaryEmail, ROOT_PATH));
  }
