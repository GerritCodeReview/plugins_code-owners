...
public class RenameEmailIT extends AbstractCodeOwnersIT {
  ...
  @Test
  public void renameEmailRequiresDirectPushPermissions() throws Exception {
  ...
  @Test
  public void renameEmailWithDirectPushPermission() throws Exception {
    // renaming email is not supported for the proto backend
    assume().that(backendConfig.getDefaultBackend()).isNotInstanceOf(ProtoBackend.class);
  ...
  @Test
  public void renameEmailAsProjectOwner() throws Exception {
    // renaming email is not supported for the proto backend
    assume().that(backendConfig.getDefaultBackend()).isNotInstanceOf(ProtoBackend.class);
