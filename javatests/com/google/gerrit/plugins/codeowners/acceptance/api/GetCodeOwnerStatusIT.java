...
public class GetCodeOwnerStatusIT extends AbstractCodeOwnersIT {
  ...
  public void getStatusWithLimitForRename() throws Exception {
    testGetStatusWithLimitForRenamedFile(/* useNewDiffCache= */ false);
  }
  ...
  public void getStatusWithLimitForRename_useNewDiffCache() throws Exception {
    testGetStatusWithLimitForRenamedFile(/* useNewDiffCache= */ true);
  }

  private void testGetStatusWithLimitForRenamedFile(boolean useNewDiffCache) throws Exception {
    codeOwnerConfigOperations
        .newCodeOwnerConfig()
        .project(project)
        .branch("master")
  ...
  public void getStatusForRenamedFile() throws Exception {
    testGetStatusForRenamedFile(/* useNewDiffCache= */ false);
  }
  ...
  @GerritConfig(
      name = "experiments.enabled",
      value = CodeOwnersExperimentFeaturesConstants.USE_NEW_DIFF_CACHE)
  public void getStatusForRenamedFile_useNewDiffCache() throws Exception {
    testGetStatusForRenamedFile(/* useNewDiffCache= */ true);
  }

  private void testGetStatusForRenamedFile(boolean useNewDiffCache) throws Exception {
    TestAccount user2 = accountCreator.user2();
