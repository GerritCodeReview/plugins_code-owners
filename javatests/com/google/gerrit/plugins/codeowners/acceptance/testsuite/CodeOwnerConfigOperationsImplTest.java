...
public class CodeOwnerConfigOperationsImplTest extends AbstractCodeOwnersTest {
  ...
  @Test
  public void getAbsoluteFilePath() throws Exception {
    CodeOwnerConfig.Key codeOwnerConfigKey =
        codeOwnerConfigOperations
            .newCodeOwnerConfig()
            .project(project)
            ...
            .addCodeOwnerEmail(admin.email())
            .create();
    assertThat(codeOwnerConfigOperations.codeOwnerConfig(codeOwnerConfigKey).getAbsoluteFilePath())
        .isEqualTo("/foo/OWNERS");
  }
  ...
  @Test
  public void getAbsoluteFilePath_nonExistingCodeOwnerConfig() throws Exception {
    CodeOwnerConfig.Key codeOwnerConfigKey = CodeOwnerConfig.Key.create(project, "master", "/foo/");
    assertThat(codeOwnerConfigOperations.codeOwnerConfig(codeOwnerConfigKey).getAbsoluteFilePath())
        .isEqualTo("/foo/OWNERS");
  }
  ...
  @Test
  public void getAbsoluteFilePath_nonExistingProject() throws Exception {
    CodeOwnerConfig.Key codeOwnerConfigKey =
        CodeOwnerConfig.Key.create(Project.nameKey("non-existing"), "master", "/foo/");
    assertThat(codeOwnerConfigOperations.codeOwnerConfig(codeOwnerConfigKey).getAbsoluteFilePath())
        .isEqualTo("/foo/OWNERS");
