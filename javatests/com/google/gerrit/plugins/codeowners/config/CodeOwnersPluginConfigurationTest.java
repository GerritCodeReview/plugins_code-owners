...
public class CodeOwnersPluginConfigurationTest extends AbstractCodeOwnersTest {
  ...
  @Test
  public void inheritedDisabledValueIsIgnored() throws Exception {
    configureDisabled(project, "invalid");
    assertThat(codeOwnersPluginConfiguration.isDisabled(project)).isFalse();
  }

  @Test
  public void inheritedDisabledValueIsIgnoredForBranch() throws Exception {
    configureDisabled(project, "invalid");
    assertThat(codeOwnersPluginConfiguration.isDisabled(BranchNameKey.create(project, "master")))
        .isFalse();
  }
  ...
  @Test
  public void cannotCheckEnabledForNullBranch() throws Exception {
    NullPointerException npe =
        assertThrows(
            NullPointerException.class, () -> codeOwnersPluginConfiguration.checkEnabled(null));
    assertThat(npe).hasMessageThat().isEqualTo("branchNameKey");
  }

  @Test
  public void checkEnabled() throws Exception {
    codeOwnersPluginConfiguration.checkEnabled(BranchNameKey.create(project, "master"));
  }

  @Test
  public void checkEnabledThrowsExceptionIfDisabled() throws Exception {
    disableCodeOwnersForProject(project);
    MethodNotAllowedException exception =
        assertThrows(
            MethodNotAllowedException.class,
            () ->
                codeOwnersPluginConfiguration.checkEnabled(
